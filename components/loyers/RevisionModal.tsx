        ...
        {!showLettre ? (
              ...
              <div className="p-4 rounded-xl bg-green-400/5 border border-green-400/20 space-y-2.5">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white font-mono">{ancienVal}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-400">Indice actuel ({newQuarterLabel})</span>
                    <span className="text-white font-mono">{nouvelIndice}</span>
                  </div>
                  <div className="flex justify-between text-sm border-t border-white/[0.06] pt-1.5">
                    ...
                    <span className="text-white">{formatCurrency(lease.monthly_rent)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <p className="text-sm font-medium text-white">Lettre de révision</p>
              <button onClick={() => setShowLettre(false)} className="text-xs text-slate-400 hover:text-white">← Retour</button>
            </div>
