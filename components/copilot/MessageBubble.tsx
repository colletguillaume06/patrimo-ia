...
export function MessageBubble({ message }: MessageBubbleProps) {
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="max-w-[85%] px-4 py-3 rounded-2xl rounded-tl-sm bg-bg-secondary border border-border text-sm text-slate-200">
        {message.content ? (
          <div className="prose prose-invert prose-sm max-w-none prose-p:my-1 prose-ul:my-1 prose-li:my-0.5 prose-headings:text-text-primary prose-strong:text-text-primary">
