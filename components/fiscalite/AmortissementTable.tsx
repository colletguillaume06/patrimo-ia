...
export function AmortissementTable({ plans }: AmortissementTableProps) {
  ...
  return (
    <GlassCard>
      <h3 className="font-display font-semibold text-white mb-4">Plan d'amortissement</h3>
            ...
            <div key={plan.id} className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-sm font-semibold text-white">{formatCurrency(plan.annual_amount)}/an</span>
