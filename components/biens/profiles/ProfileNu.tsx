    ...
    <div className="space-y-6">
      <GlassCard glow="blue" className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Revenus bruts', value: formatCurrency(revenus_bruts), color: 'text-white' },
      ...
      <GlassCard>
        <h3 className="font-display font-semibold text-white mb-4">Charges déductibles détectées</h3>
        {deductibleExpenses.length === 0 ? (
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between pt-2">
              <span className="text-sm font-semibold text-white">Total déductible</span>
