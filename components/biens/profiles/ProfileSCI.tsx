    ...
    <div className="space-y-6">
      <GlassCard glow="cyan" className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Résultat comptable', value: formatCurrency(resultat), color: resultat >= 0 ? 'text-white' : 'text-red-400' },
      ...
      <GlassCard>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display font-semibold text-white">Répartition des parts</h3>
        </div>
      ...
      {/* Alertes SCI */}
      <GlassCard>
        <h3 className="font-display font-semibold text-white mb-4">Obligations SCI</h3>
