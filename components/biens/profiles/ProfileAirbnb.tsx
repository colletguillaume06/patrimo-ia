    ...
    <div className="space-y-6">
      <GlassCard glow="amber" className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'RevPAR', value: formatCurrency(revPar), color: 'text-white' },
            ...
            { label: 'Nuits réservées', value: `${totalNights}`, color: totalNights > 100 ? 'text-red-400' : 'text-white' },
      ...
      <GlassCard>
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-semibold text-white">Compteur annuel (loi ELAN)</h3>
          {isNearLimit && (
        ...
        <div className="flex items-center justify-between mb-2 text-sm">
          ...
          <span className="font-semibold text-white">{nightsRemaining} restantes</span>
        </div>
      ...
      <GlassCard>
        <h3 className="font-display font-semibold text-white mb-4">Réservations récentes</h3>
        {bookings.length === 0 ? (
