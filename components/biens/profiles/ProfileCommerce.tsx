    ...
    <div className="space-y-6">
      <GlassCard glow="cyan" className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'Loyer HT mensuel', value: formatCurrency(loyer_ht), color: 'text-[var(--text-primary)]' },
      ...
      {startDate && (
        <GlassCard>
          <h3 className="font-display font-semibold text-[var(--text-primary)] mb-4">Timeline bail 3-6-9</h3>
            ...
            {[3, 6, 9].map(year => {
              ...
              return (
                <div key={year} className="flex items-center gap-4 mb-4 pl-10 relative">
                  ...
                  <div>
                    <p className="text-sm font-medium text-[var(--text-primary)]">Fin période {year} ans</p>
      ...
      {/* Checklist */}
      <GlassCard>
        <h3 className="font-display font-semibold text-[var(--text-primary)] mb-4">Obligations bail commercial</h3>
