    ...
    return (
      <div className="flex items-center gap-2">
        <div className="group relative flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.04] border border-white/[0.08]">
          ...
          <div className="absolute bottom-7 left-0 w-64 px-3 py-2 bg-[#0D1B2E] border border-white/[0.10] rounded-lg text-xs text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10 shadow-xl">
