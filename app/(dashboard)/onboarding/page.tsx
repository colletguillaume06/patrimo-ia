      ...
      <div className="w-full max-w-xl relative">
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8">
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                <h1 className="font-display font-bold text-2xl text-white mb-1">Votre portefeuille</h1>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div>
                <h1 className="font-display font-bold text-2xl text-white mb-1">Votre situation fiscale</h1>
          ...
          {step === 4 && (
            <div className="text-center py-4 space-y-6">
              ...
              <button
                ...
                disabled={saving}
                className="w-full flex items-center justify-center gap-2 h-12 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white text-sm font-semibold transition-all disabled:opacity-50 shadow-lg shadow-blue-500/20"
              >
            ...
            <div className="flex items-center gap-3 mt-8">
              {step > 1 && (
                <button
                  ...
                  className="flex items-center gap-1.5 h-11 px-4 rounded-xl border border-white/[0.10] text-slate-400 hover:text-white text-sm font-medium transition-all"
                >
              ...
              <button
                onClick={() => setStep(s => s + 1)}
                disabled={!canNext()}
                className="flex-1 flex items-center justify-center gap-2 h-11 rounded-xl bg-blue-500 hover:bg-blue-400 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold transition-all"
              >
