  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display font-bold text-xl text-white">Financement</h1>
      </div>

      {/* Formulaire prêt */}
      <GlassCard>
        <h2 className="font-display font-semibold text-white mb-4">Paramètres du prêt</h2>
      ...
      {hasPret && kpis && (
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: 'Mensualité totale', value: formatCurrency(kpis.mensualite_avec_assurance), sub: `dont ${formatCurrency(kpis.mensualite)} hors assurance`, color: 'text-white' },
          ...
          <GlassCard>
            <h3 className="font-display font-semibold text-white mb-4">Évolution du capital restant dû</h3>
          ...
          <GlassCard>
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-display font-semibold text-white">Tableau d'amortissement</h3>
                  ...
                  {pageData.map(e => {
                    ...
                    return (
                      <tr key={e.numero} className={`border-b border-white/[0.04] text-right ${isCurrentMonth ? 'bg-blue-500/10' : 'hover:bg-white/[0.02]'}`}>
                        ...
                        <td className="py-2.5 px-3 text-white font-medium">{formatCurrency(e.mensualite)}</td>
