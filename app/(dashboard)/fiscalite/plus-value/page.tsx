  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/fiscalite" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-white">
          <ChevronLeft className="h-4 w-4" /> Fiscalité
        </Link>
        <h1 className="font-display font-bold text-2xl text-white">Simulateur plus-value</h1>
      </div>

      <GlassCard>
        <h2 className="font-display font-semibold text-white mb-4">Données du bien</h2>
      ...
      {result && (
        <>
          <GlassCard glow={result.exonere_ir && result.exonere_ps ? 'green' : 'amber'}>
            <h2 className="font-display font-semibold text-white mb-4">Résultat de la simulation</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
              {[
                { label: 'Prix de revient', value: formatCurrency(result.prix_revient), color: 'text-white' },
          ...
          <GlassCard>
            <h2 className="font-display font-semibold text-white mb-4">Paliers d'abattement</h2>
