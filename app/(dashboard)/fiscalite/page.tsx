    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
            ...
            {YEARS.map(y => (
              <button key={y} onClick={() => setYear(y)}
                className={`h-9 px-3 rounded-lg text-sm font-medium transition-all ${
                  year === y ? 'bg-blue-500 text-white' : 'bg-white/[0.05] border border-white/[0.08] text-slate-400 hover:text-white'
                }`}>
                {y}
              </button>
            ))}
          ...
          <select value={selectedPropId} onChange={e => setSelectedPropId(e.target.value)}
            className="h-9 px-3 rounded-lg bg-white/[0.06] border border-white/[0.10] text-white text-sm focus:outline-none focus:border-blue-500/50 max-w-[180px]">
      ...
      {loading ? (
        ...
        <>
          ...
          <GlassCard>
            <h2 className="font-display font-semibold text-white mb-4">Résumé par bien — {year}</h2>
              ...
              <table className="w-full text-sm">
                ...
                <tfoot>
                  <tr className="border-t-2 border-white/[0.12] bg-white/[0.02]">
                    <td className="py-3 px-3 font-bold text-white" colSpan={4}>TOTAL</td>
          ...
          <div>
            <h2 className="font-display font-semibold text-white mb-3">Ce que vous devez déclarer</h2>
          ...
          <div>
            <h2 className="font-display font-semibold text-white mb-3">Calendrier fiscal {year}</h2>
            <GlassCard>
          ...
          {/* Indices */}
          <GlassCard>
            <h2 className="font-display font-semibold text-white mb-4">Indices de référence ({getQuarterLabel()})</h2>
