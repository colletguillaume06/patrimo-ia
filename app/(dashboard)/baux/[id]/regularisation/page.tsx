  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display font-bold text-xl text-[#0A0908]">Régularisation des charges</h1>
      </div>

      <GlassCard>
        <h2 className="font-display font-semibold text-[#0A0908] mb-4">Type de charges</h2>
      ...
      {form.charges_type === 'provision' && (
        <GlassCard>
          <h2 className="font-display font-semibold text-[#0A0908] mb-4">Calcul de régularisation {form.annee}</h2>
