    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-display font-bold text-xl text-white">Relevé de compte</h1>
        </div>
        <button onClick={exportTxt} className="flex items-center gap-2 h-9 px-4 rounded-xl bg-white/[0.06] border border-white/[0.08] text-slate-300 hover:text-white text-sm transition-all">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Total attendu', value: formatCurrency(total_attendu), color: 'text-white' },
          ...
          <table className="w-full text-sm">
              ...
              {rows.map((r, i) => {
                ...
                return (
                  <tr key={r.id} className="border-b border-white/[0.04] hover:bg-white/[0.02] text-right">
                    ...
                    <td className="py-2.5 px-3 text-white">{formatCurrency(r.attendu)}</td>
            ...
            <tfoot>
              <tr className="border-t-2 border-white/[0.12] bg-white/[0.02] text-right">
                <td className="py-3 px-3 text-left font-bold text-white">TOTAL</td>
                <td className="py-3 px-3 font-bold text-white">{formatCurrency(total_attendu)}</td>
